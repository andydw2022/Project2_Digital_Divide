...
var colorscale = dv;
// function favcolorscale() {
//   var mylist = document.getElementById("myList");
//   var colorchoice = mylist.value;
...
d3.selectAll("input").on("change", function change() {
  if (this.value === "DVG") {
   ...
   legend.remove(myMap);
   var div = L.DomUtil.remove("div", "info legend");
   drawmap2(geojson, dv ) ;
 } else {
   console.log('CBS');
   var div = L.DomUtil.remove("div", "info legend");
...
// });
// Grab data with d3
function drawmap1(geojson, colorscale ){
d3.json(geoData).then(function(data) {
...
function drawmap2(geojson, colorscale ){
  d3.json(geoData).then(function(data) {
     console.log('redraw  ',data);
         // Create a new choropleth layer
    geojson = L.choropleth(data, {
